    ...
    <div class="site-card rounded-3xl border border-white/10 p-8 sm:p-12 space-y-8 text-xs text-zinc-300 leading-relaxed shadow-2xl">
        ...
        <section class="space-y-3">
            <h2 class="text-base font-bold text-white flex items-center gap-2">
                ...
                <span>Booking, Deposits & CashFree/Razorpay Payments</span>
            </h2>
            <p>
                All photoshoot reservations require payment of a deposit or the full package amount at the time of booking. Payments on our website are securely processed via <strong>CashFree/Razorpay</strong>.
            </p>
            <ul class="list-disc list-inside space-y-1.5 pl-2 text-zinc-400">
                ...
                <li>Your booking is confirmed immediately upon successful capture of the transaction through CashFree/Razorpay.</li>
