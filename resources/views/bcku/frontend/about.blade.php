  ...
  <div class="max-w-7xl mx-auto relative z-10 space-y-24">
    ...
    <div class="text-center max-w-3xl mx-auto space-y-6 reveal">
      ...
      <h1 class="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-white">
        Behind The <span class="text-gold-gradient">MK Production Lens</span>
      </h1>
      ...
      <h4 class="font-serif text-3xl text-white">
       The <span class="text-gold-gradient">UKVI</span> View
      </h4>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <div class="lg:col-span-7 space-y-8 reveal reveal-right">
        ...
        <p class="text-gray-400 font-light leading-relaxed">
          Founded in 2018, MK Production emerged from a singular conviction: photography is not simply the recording of a scene; it is the curation of light and emotion to construct a legacy.
        </p>
    ...
    <div class="space-y-12">
      ...
      <div class="relative border-l border-white/10 max-w-3xl mx-auto pl-8 space-y-12 reveal">
        ...
        <div class="relative">
          ...
          <h4 class="text-lg font-bold text-white mt-1">Inception of MK Production | UKVI</h4>
