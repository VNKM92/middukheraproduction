    ...
    <div class="site-card rounded-3xl border border-white/10 p-8 sm:p-12 space-y-8 text-xs text-zinc-300 leading-relaxed shadow-2xl">
        ...
        <section class="space-y-3">
            <h2 class="text-base font-bold text-white flex items-center gap-2">
                ...
                <span>Payment Processing & Security (CashFree/Razorpay)</span>
            </h2>
            <p>
                We do not store, process, or retain sensitive card numbers, CVVs, or banking PINs on our servers. All financial transactions are securely processed through our certified payment gateway partner, <strong>CashFree/Razorpay Software Private Limited</strong>.
            </p>
            <p>
                CashFree/Razorpay adheres to the highest level of Payment Card Industry Data Security Standards (<strong class="text-white">PCI-DSS Level 1</strong> compliant) and uses 256-bit SSL encryption to guarantee that all payment information transmitted is completely protected and confidential.
            </p>
        </section>
