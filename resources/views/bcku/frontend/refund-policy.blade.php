        ...
        <section class="space-y-3">
            ...
            <div class="p-5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-zinc-200 space-y-2">
                <p class="font-bold text-emerald-400 text-sm flex items-center gap-2">
                    ...
                    <span>Mandatory Refund Timeline (CashFree/Razorpay Standard)</span>
                </p>
                <p>
                    All eligible refunds approved by {{ $siteSettings['site_name'] ?? 'Middukhera Production' }} will be processed electronically through our payment gateway (CashFree/Razorpay). 
                </p>
